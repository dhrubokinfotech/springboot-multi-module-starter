...
import com.disl.startercore.repository.UserRepository;
...
public class UserService {
	...
	public User findByEmailWithException(String email) {
		return userRepository.findTopByEmail(email).orElseThrow(() ->
				new ResponseException(HttpStatus.NOT_FOUND, "No user found with this email")
		);
	}
	...
	public void createNewUser(SignUpRequest request) {
		...
		Role role = roleService.findRoleByNameWithException(AppConstants.USER_ROLE);
