package com.disl.startercore.features.notification.service;
...
import com.disl.startercore.features.notification.model.PushNotificationRequest;
import com.disl.startercore.features.notification.model.SendNotificationRequest;
import com.disl.startercore.features.notification.repository.NotificationRepository;
import com.disl.startercore.services.UserService;
import com.disl.startercore.SpringBootMultiModuleStarterApplication;
    ...
    private void sendPushNotification(Notification notification) {
        if (notification != null) {
            try {
                ...
                e.printStackTrace();
                SpringBootMultiModuleStarterApplication.logger.info("push notification error: {}", e.getMessage());
            }
        }
    }
